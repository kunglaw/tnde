...
<div align="center" style="width:800px;">
   	...
   	<input type="button" id="button" value="PDF" onclick="window.open('surat_masuk/report_lsm.php?awal=<?php echo $_GET["awal"]; ?>&akhir=<?php echo $_GET["akhir"]; ?>');"/> 
    <input type="button" id="button" value="PRINT" onclick="window.open('surat_masuk/view_lsm_pdf.php?awal=<?php echo $_GET["awal"]; ?>&print=1&akhir=<?php echo $_GET["akhir"]; ?>');"/> &nbsp;
